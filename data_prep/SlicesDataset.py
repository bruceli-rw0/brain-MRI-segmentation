...
class SlicesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Hint2: You can use None notation like so: arr[None, :] to add size-1 dimension to a Numpy array
        i, j = slc
        sample['image'] = torch.from_numpy(self.data[i]['image'][j][None,:].astype(np.single))
